...
from vla_precision.acob.augmentation import resize
ModuleDef = Any
...
class FilmConditioning(nn.Module):
    ...
    def __call__(self, conv_filters: jnp.ndarray, conditioning: jnp.ndarray):
        """Apply FiLM conditioning to a convolutional feature map."""
...
class EncodingWrapper(nn.Module):
    """Encode image observations and optionally concatenate proprioception."""
